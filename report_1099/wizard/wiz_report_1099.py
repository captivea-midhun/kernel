...
class WizReport1099(models.TransientModel):
    ...
    def get_invoices(self):
        ...
        for inv in invoice_ids:
            ...
            id_no = partner.ein_number
            if partner.ssn_ein == 'ssn':
                id_no = partner.ssn_number
                ...
                for inv_line in inv.invoice_line_ids.filtered(
                    ...
                    if inv.state != 'posted':
                        ...
                        debit_line_dict = {
                            ...
                            'id_number': id_no,
                            'type_income': debit_line.partner_id.type_income,
                            'ssn_ein': debit_line.partner_id.ssn_ein,
                            'legal_name': debit_line.partner_id.legal_name,
    ...
    def print_xls_report(self):
        ...
        for partner_id, income_dict in data_dict.items():
            ...
            recpnt_no = ''
            if partner.ssn_ein:
                if partner.ssn_ein == 'ein':
                    recpnt_no = partner.ein_number or ''
                if partner.ssn_ein == 'ssn':
                    recpnt_no = partner.ssn_number or ''
