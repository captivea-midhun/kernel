odoo.define('credit_card_reconciliation.ReconciliationRenderer', function(
        require) {
    "use strict";
    ...
    LineRenderer.include({
        _onFieldChanged: function (event) {
            ...
            if (fieldName === 'to_attachment') {
                if(event.data.changes.to_attachment == false){
                    console.log("in if")
                    self.fields.to_attachment.value = false
                    self.fields.to_attachment.$el.value = ''
                }else{
                    self.fields.to_attachment.value = event.data.changes
                }
            }
        ...
        _renderCreate: function (state) {
            ...
            return this.model.makeRecord('account.bank.statement.line', [{
                ...
                self.fields.to_attachment = new basic_fields.FieldBinaryFile(self,
                        'to_attachment', record, {mode: 'edit'});
                ...
                self.fields.to_attachment.appendTo($create.find('.create_to_attachment .o_td_field'));
