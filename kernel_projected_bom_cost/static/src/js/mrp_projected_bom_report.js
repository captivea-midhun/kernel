odoo.define('kernel_projected_bom_cost.mrp_projected_bom_report', function (require) {
'use strict';
...
var MrpBomReport = stock_report_generic.extend({
    ...
    get_html: function() {
        ...
        return this._rpc({
                model: 'report.kernel_projected_bom_cost.projected_bom_structure',
                method: 'get_html',
                args: args,
    ...
    _onClickPrint: function (ev) {
        ...
        framework.blockUI();
        var reportname = 'kernel_projected_bom_cost.projected_bom_structure?docids=' + this.given_context.active_id +
        ...
        var action = {
            ...
            'report_file': 'kernel_projected_bom_cost.projected_bom_structure',
        };
...
core.action_registry.add('mrp_projected_bom_report', MrpBomReport);
return MrpBomReport;
