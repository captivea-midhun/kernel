odoo.define('setu_mrp_mps_extended.ClientAction', function (require) {
'use strict';
...
var ClientAction = AbstractAction.extend({
    ...
    update_cp: function () {
        var self = this;
        this.$buttons = $(QWeb.render('setu_mrp_mps_control_panel_buttons'));
        ...
        this.$searchview_buttons = $(QWeb.render('setu_mrp_mps_control_panel_option_buttons', {groups: self.groups}));
    ...
    _reloadContent: function () {
        ...
        return this._getState().then(function () {
            var $content = $(QWeb.render('setu_mrp_mps', {
                widget: {
    ...
    _onClickReplenish: function (ev) {
        ...
        var $table = $(ev.target).closest('.o_mps_content');
        if ($table.length) {
...
core.action_registry.add('setu_mrp_mps_client_action', ClientAction);
